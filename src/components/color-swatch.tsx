...
const ColorSwatch: React.FC<ColorSwatchProps> = React.memo(function ColorSwatch({ color, onClick, size = 'medium', className = '' }) {
  const sizeClasses = {
    small: 'h-20 w-20 sm:h-24 sm:w-24',
    medium: 'h-24 w-24 sm:h-32 sm:w-32 md:h-40 md:w-40 lg:h-48 lg:w-48',
